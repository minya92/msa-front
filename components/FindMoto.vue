    ...
    <div id="find_moto">
      ...
      <div class="find-moto__content">
        <div class="moto-box-selection">
          <div class="form-group">
            ...
            <div class="slider-marks">
              <div
                :class="[
                  'slider-mark',
                  currentMark == mark.marks_models_id ? 'current' : ''
                ]"
                v-for="mark in marks"
                @click="
                  clearModel();
                  currentMark = mark.marks_models_id;
                "
          ...
          <div class="form-group" v-if="models">
            ...
            <div class="slider-marks">
              <div
                ...
                :class="[
                  'slider-mark',
                  currentModel == model.marks_models_id ? 'current' : ''
                ]"
                @click="
                  clearYear();
                  currentModel = model.marks_models_id;
                "
          ...
          <div class="form-group" v-if="years && years.length > 0">
            ...
            <div class="years slider-marks">
              <div
                ...
                :class="[
                  'slider-mark',
                  currentYear == year.marks_models_id ? 'current' : ''
                ]"
          ...
          <button
            class="primary btn_theme search-detail"
            v-if="currentMark"
            @click.stop="showMore()"
          >
            Показать
