<template>
  <footer>
    <div class="footer-top__ss">
      Наши каналы:
      <a
        target="_blank"
        href="https://www.instagram.com/msa_moto/"
        class="footer-top__ssi"
      >
        <svg
          width="28px"
          height="28px"
      ...
      <a
        target="_blank"
        href="https://www.facebook.com/msamotoKT"
        class="footer-top__ssi"
      >
        <svg
          width="28px"
      ...
      <a
        target="_blank"
        href="https://www.youtube.com/channel/UCAqrLCG9-BwvSQPqpyvqSqQ"
        class="footer-top__ssi"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="footer-top">
      <ul class="footer-top__menu container-fluid">
        <li><nuxt-link :to="{ name: 'review' }">Отзывы</nuxt-link></li>
        <li>
          <nuxt-link :to="{ name: 'contact-us' }">Напишите нам</nuxt-link>
        </li>
        <li>
          <nuxt-link :to="{ name: 'info' }">Правила магазина</nuxt-link>
        </li>
        <li><nuxt-link :to="{ name: 'faq' }">Вопрос и ответ</nuxt-link></li>
      ...
      <div class="container-fluid footer-bottom__content">
        <div class="fbox-lr">
          <div class="fbox-l-container">
            <a target="_blank" href="https://vk.com/msamoto_official"
              ><img src="../assets/img/vk_grey.svg"
            /></a>
            <a target="_blank" href="https://www.facebook.com/msamotoKT"
              ><img src="../assets/img/fb_grey.svg"
            /></a>
            <a
              target="_blank"
              href="https://www.youtube.com/channel/UCAqrLCG9-BwvSQPqpyvqSqQ"
              ><img src="../assets/img/youtube_grey.svg"
            /></a>
            <a target="_blank" href="https://www.instagram.com/msa_moto/"
        ...
        <div class="fbox-c">
          ...
          <div class="fbox-c-menu">
            <nuxt-link :to="{ name: 'manufactures' }">Производители</nuxt-link>
            <nuxt-link :to="{ name: 'payment-delivery' }"
              >Оплата и доставка</nuxt-link
            >
            <nuxt-link :to="{ name: 'about' }">О магазине</nuxt-link>
          </div>
        </div>
        <div class="fbox-lr">
...
footer .search_input label {
  position: absolute;
  right: 10px;
  top: 5px;
}
footer .search_input input[type='text'] {
  border-radius: 15px;
  height: 30px;
  padding: 0 25px;
  font-size: 14px;
