  ...
  <div class="my-image-sliders" v-if="images.length > 0">
    <div class="my-image-sliders__close" @click.prevent="$emit('close')">
      ...
      >
        <path
          style="fill:#801f25;"
          d="M 0 13.2 C 0 13.2 13.13 -0.01 13.13 -0.01 C 13.13 -0.01 14.64 1.52 14.64 1.52 C 14.64 1.52 1.51 14.73 1.51 14.73 C 1.51 14.73 0 13.2 0 13.2 Z"
        ></path>
        <path
          style="fill:#801f25;"
          d="M 1.87 0.27 C 1.87 0.27 15 13.48 15 13.48 C 15 13.48 13.49 15 13.49 15 C 13.49 15 0.36 1.79 0.36 1.79 C 0.36 1.79 1.87 0.27 1.87 0.27 Z"
        ></path>
      </svg>
    </div>
