    ...
    <div class="oc-modal">
      ...
      <div class="oc-item">
        ...
        <div class="oc-action-block" v-if="status == 0">
          <div class="oc-info">
            После отправки заказа наши менеджеры свяжутся с Вами в ближайшее
            время
          </div>
          <div class="v-block">
            <label>ФИО</label>
          ...
          <div class="form-group">
            <button class="btn_theme oc-buy" @click="buy()">
              Оформить заказ
            </button>
          </div>
        </div>
        ...
        <div class="oc-action-block" v-else-if="status == -1">
          <div class="oc-info">
            Не удалось выполнить заказ. Свяжитесь с нашими менеджерами, они Вам
            помогут.
          </div>
        </div>
        ...
        <div class="oc-action-block" v-else-if="status == 1">
          <div class="oc-info">
            Заказ отправлен. Наши менеджеры свяжутся с Вами с ближайшее время.
          </div>
        </div>
      </div>
    </div>
