<template>
  <footer>
			<div class="footer-top__ss">Наши каналы:
				...
				<a target="_blank" href="https://www.youtube.com/channel/UCAqrLCG9-BwvSQPqpyvqSqQ" class="footer-top__ssi">
					...
					<div class="fbox-c">
						<div class="fbox-c-phone">
							<a
								...
								:key="index"
							>
							<svg version="1.1" role="presentation" width="12.571428571428571" height="16" viewBox="0 0 1408 1792" class="fa-icon" fill="#9b9b9b">
