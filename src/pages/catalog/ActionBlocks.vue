<template>
  <div class="bottom-action">
    <div class="block-action" v-for="(blockAction, index) in blockActions" :key="index">
  ...
  data(){
    return{
      blockActions: [
        ...
        {
          headerText: 'Более 7000 вариантов расцветки пластика',
          footerText: 'Даже если в магазине нет определенной расцветки для обтекателей Вашей мечты - задавайте вопросы, мы готовы к новым вызовам!',
