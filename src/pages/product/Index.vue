      ...
      <div class="content-fluid">
        ...
        <div class="product__detail">
          ...
          <div class="product__detail__description">
            ...
            <div>
              <div>На фотографии изображен только вариант расцветки пластика. Комплектность поставки полностью совпадает с оригинальным комплектом, поставляемым заводом изготовителем мотоцикла для этой модели</div>
            </div>
          </div>
        </div>
      </div>
